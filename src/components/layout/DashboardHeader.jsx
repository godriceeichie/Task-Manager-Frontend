...
import AccountModal from '../container/account/AccountModal';
import UserHeaderProfile from '../container/account/UserHeaderProfile';
        ...
        <header className='dashboardHeader'>
            <div className='dashboardHeader__container'>
                ...
                <div className="dashboardHeader__searchbar">
                    ...
                    <input type="search" placeholder='Search' value={taskSearchInput} onChange={(e) => setTaskSearchInput(e.target.value.toLowerCase())}/>
                </div>
                <div className="dashboardHeader__userInfo">
                    ...
                    <UserHeaderProfile username={user && user.username} email={user && user.email}/>
                </div>
            </div>
        </header>
    );
